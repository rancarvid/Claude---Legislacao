...
def add_article_section(doc, art):
    ...
    # Linha 0: Headers (3 colunas)
    cell_header(t_div.cell(0, 0), "@legislacao", COR["legislacao_header"])
    cell_header(t_div.cell(0, 1), "@codigo", COR["codigo_header"])
    cell_header(t_div.cell(0, 2), "@rgbeac", COR["rgbeac_header"])

    # Linha 1: Textos (3 colunas)
    ...
    # Linha 2: Sumário (merged 3 colunas)
